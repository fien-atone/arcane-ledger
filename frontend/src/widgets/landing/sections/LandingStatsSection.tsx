/**
 * LandingStatsSection — horizontal strip of marketing stats beneath the hero.
 *
 * Four centered figures: entity types, locations/maps, the d20 glyph for the
 * dice roller, and an "in active dev" badge. The d20 is an inline SVG so it
 * can inherit the primary text color without a separate icon component.
 */
...
export function LandingStatsSection() {
  ...
  const items: { n: ReactNode; label: string }[] = [

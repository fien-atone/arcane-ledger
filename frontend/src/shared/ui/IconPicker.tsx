...
const ICONS: string[] = [
  ...
  'air', 'thunderstorm', 'cloud', 'public', 'diamond', 'biotech',
  // Animals & Creatures
  'pets', 'cruelty_free', 'hive', 'coronavirus', 'egg',
  // Buildings & Places
    ...
    <div>
      ...
      >
        ...
        <span className="flex-1 text-sm text-on-surface font-mono">
          {value || <span className="text-on-surface-variant/40 font-sans">{placeholder}</span>}
        </span>
        ...
        <div className="mt-1 border border-outline-variant/20 rounded-sm bg-surface-container-low overflow-hidden">
          <div className="p-2 border-b border-outline-variant/10">
            <div className="relative">
              <span className="material-symbols-outlined absolute left-2.5 top-1/2 -translate-y-1/2 text-[14px] text-on-surface-variant/40">search</span>
              <input
                ref={searchRef}
                type="text"

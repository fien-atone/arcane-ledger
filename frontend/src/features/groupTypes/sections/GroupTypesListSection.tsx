/**
 * GroupTypesListSection — left column of the GroupTypes admin page.
 *
 * Renders the searchable list of group types as a flat, server-filtered
...
export function GroupTypesListSection({
  types,
  search,
  onSearchChange,
  selectedId,
        ...
        {isEmpty ? (
          ...
          types.map((entry) => {
            ...
            return (
              ...
              >
                <div
                  className={`w-10 h-10 rounded-sm flex-shrink-0 flex items-center justify-center border ${
                    isActive

...
const CATEGORY_STYLES: Record<LocationTypeCategory, { ring: string; bg: string; text: string; dot: string }> = {
  world:      { ring: 'border-blue-400/60',   bg: 'bg-blue-950/80',    text: 'text-blue-200',    dot: 'bg-blue-400' },
  ...
  explorable: { ring: 'border-rose-400/60',    bg: 'bg-rose-950/80',    text: 'text-rose-200',    dot: 'bg-rose-400' },
  linear:     { ring: 'border-violet-400/60',  bg: 'bg-violet-950/80',  text: 'text-violet-200',  dot: 'bg-violet-400' },
};
